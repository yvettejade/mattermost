...
func TestNormalizeGrokAgentIntent(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "infer jira from ticket key", message: "status of YJIRA-28", expectedIntent: GrokAgentIntentJira, expectedMessage: "status of YJIRA-28"},
...
func TestExtractJiraIssueKeys(t *testing.T) {
	...
	assert.Equal(t, []string{"YJIRA-28", "MM-100"}, ExtractJiraIssueKeys("See YJIRA-28 and MM-100, then YJIRA-28 again"))
