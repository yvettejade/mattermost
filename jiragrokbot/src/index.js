/**
 * Jira / Linear -> Cursor (Grok bot) webhook proxy.
 *
 * Source webhooks cannot attach a custom Authorization header. This Worker
 * verifies the HMAC-SHA256 signature, then forwards the unmodified raw body
 * to the Cursor automation webhook with the auth header attached.
 *
 ...
 *   - CURSOR_AUTH_TOKEN     : webhook bearer token, without the "Bearer " prefix (secret)
