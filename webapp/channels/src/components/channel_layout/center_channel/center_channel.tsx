...
import {EXPORT_MONITOR_URL_SUFFIX, SCHEDULED_POST_URL_SUFFIX} from 'utils/constants';
...
const ExportMonitor = makeAsyncComponent('ExportMonitor', lazy(() => import('components/export_monitor')),
    (
        <div className='app__content'>
            <LoadingScreen/>
        </div>
            ...
            >
                ...
                <div className='row main'>
                    <Switch>
                        ...
                        />
                        <Route
                            path={`/:team(${TEAM_NAME_PATH_PATTERN})/${EXPORT_MONITOR_URL_SUFFIX}`}
