...
import {ONLINE_URL_SUFFIX, SCHEDULED_POST_URL_SUFFIX} from 'utils/constants';
...
const Online = makeAsyncComponent('Online', lazy(() => import('components/online')),
    (
        <div className='app__content'>
            <LoadingScreen/>
        </div>
            ...
            >
                ...
                <div className='row main'>
                    <Switch>
                        ...
                        />
                        <Route
                            path={`/:team(${TEAM_NAME_PATH_PATTERN})/${ONLINE_URL_SUFFIX}`}
                            component={Online}
                        />
                        <Route
