...
import {ONLINE_PAY_URL_SUFFIX, SCHEDULED_POST_URL_SUFFIX} from 'utils/constants';
...
const PayAnyone = makeAsyncComponent('PayAnyone', lazy(() => import('components/online_pay')),
    (
        <div className='app__content'>
            <LoadingScreen/>
        </div>
            ...
            >
                ...
                <div className='row main'>
                    <Switch>
                        ...
                        />
                        <Route
                            path={`/:team(${TEAM_NAME_PATH_PATTERN})/${ONLINE_PAY_URL_SUFFIX}`}
                            component={PayAnyone}
                        />
