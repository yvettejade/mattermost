...
import {LOCATE_US_URL_SUFFIX, SCHEDULED_POST_URL_SUFFIX} from 'utils/constants';
...
const LocateUs = makeAsyncComponent('LocateUs', lazy(() => import('components/locate_us')),
    (
        <div className='app__content'>
            <LoadingScreen/>
        </div>
            ...
            >
                ...
                <div className='row main'>
                    <Switch>
                        ...
                        />
                        <Route
                            path={`/:team(${TEAM_NAME_PATH_PATTERN})/${LOCATE_US_URL_SUFFIX}`}
                            component={LocateUs}
                        />
