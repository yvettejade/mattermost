...
export default function Overview({state}: Props) {
    ...
    const rapidSaveGoal = state.goals[RAPID_SAVE_ACCOUNT_ID];
            ...
            <section aria-labelledby='online-accounts-heading'>
                ...
                >
                    {state.accounts.map((account) => {
                        const showGoalHint = account.id === RAPID_SAVE_ACCOUNT_ID && hasVisibleGoal(rapidSaveGoal);
                                    ...
                                    {showGoalHint && (
                                        ...
                                        >
                                            ...
                                            <div
                                                ...
                                                aria-valuemin={0}
                                                aria-valuemax={100}
                                                aria-valuenow={goalProgressPercent(account.availableCents, rapidSaveGoal.amountCents)}
                                            >
                                                <div
                                                    className='Online__progressFill'
                                                    style={{width: `${goalProgressPercent(account.availableCents, rapidSaveGoal.amountCents)}%`}}
                                                />
                                            </div>
                                        </div>
                                    )}
