...
describe('channel_info_rhs/about_area_dm', () => {
    ...
    test('should show empty-state add header for non-bot DMs with empty header', async () => {
        const props = {
            ...defaultProps,
            channel: {
    ...
    test('should not show header block for bots even when header is empty', () => {
        const props = {
            ...defaultProps,
            channel: {
                ...defaultProps.channel,
    ...
    test('should still show empty-state header for guest human DMs', () => {
        const props = {
            ...defaultProps,
            channel: {
                ...defaultProps.channel,
    ...
    test('should show archived DM header as read-only and hide empty-state', () => {
        const props = {
            ...defaultProps,
            channel: {
                ...defaultProps.channel,
