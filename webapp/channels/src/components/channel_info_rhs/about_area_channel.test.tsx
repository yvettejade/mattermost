...
describe('channel_info_rhs/about_area_channel', () => {
    ...
    test('should display add channel header button and trigger edit when editable channel header is empty', () => {
        const props = {
            ...defaultProps,
            channel: {
    ...
    test('should not display channel header section when header is empty and channel is not editable', () => {
        const props = {
            ...defaultProps,
            channel: {
                ...defaultProps.channel,
