...
describe('channel_info_rhs/about_area_channel', () => {
    ...
    test('should display add channel header empty state and trigger edit when editable', async () => {
        const props = {
            ...defaultProps,
            channel: {
    ...
    test('should not display channel header section when header is empty and user cannot edit', () => {
        const props = {
            ...defaultProps,
            channel: {
                ...defaultProps.channel,
    ...
    test('should display empty channel header affordance for editable channels and trigger editChannelHeader when clicked', async () => {
        const props = {
            ...defaultProps,
            channel: {
                ...defaultProps.channel,
    ...
    test('should not display channel header section for empty headers when channel is not editable', () => {
        const props = {
            ...defaultProps,
            channel: {
                ...defaultProps.channel,
