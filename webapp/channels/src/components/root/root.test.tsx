...
describe('doesRouteBelongToTeamControllerRoutes', () => {
    test('should return true for some of team_controller routes', () => {
        ...
        expect(doesRouteBelongToTeamControllerRoutes('/team_name_example_1/home')).toBe(true);
        expect(doesRouteBelongToTeamControllerRoutes('/team_name_example_1/home-loans')).toBe(true);
        expect(doesRouteBelongToTeamControllerRoutes('/team_name_example_1/rates')).toBe(true);
