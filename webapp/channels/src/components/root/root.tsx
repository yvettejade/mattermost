...
import {EXPORT_MONITOR_URL_SUFFIX, PageLoadContext, SCHEDULED_POST_URL_SUFFIX} from 'utils/constants';
...
export function doesRouteBelongToTeamControllerRoutes(pathname: RouteComponentProps['location']['pathname']): boolean {
    ...
    const TEAM_CONTROLLER_PATH_PATTERN = new RegExp(`^/(?!admin_console)([a-z0-9\\-_]+)/(channels|messages|threads|recaps|drafts|integrations|emoji|${SCHEDULED_POST_URL_SUFFIX}|${EXPORT_MONITOR_URL_SUFFIX})(/.*)?$`);
