...
describe('components/drafts/DraftsAndSchedulePostsPageHeader', () => {
    ...
    test('Locate us navigates to the team locate-us page', async () => {
        ...
        await userEvent.click(screen.getByRole('button', {name: 'Locate us'}));

        expect(getHistory().push).toHaveBeenCalledWith('/team1/locate-us');
    });
});
