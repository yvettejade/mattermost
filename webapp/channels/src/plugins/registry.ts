...
export default class PluginRegistry {
    ...
    /**
     * Register a component immediately above the left-sidebar Invite Members button
     * (Direct Messages category). Accepts a React component. Returns a unique identifier.
     */
