...
func parseSummarize(lower string) (SummarizeScope, time.Duration) {
	...
	case strings.Contains(lower, "catch me up") || strings.Contains(lower, "catch up") || strings.Contains(lower, "missed") || strings.Contains(lower, "catch-up") || strings.Contains(lower, "catchup"):
...
func isSummarize(lower string) bool {
	return hasAny(lower,
		"summarize", "summarise", "recap", "catch me up", "catch up", "catch-up", "catchup",
