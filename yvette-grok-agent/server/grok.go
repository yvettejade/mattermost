...
// ChatClient is the Grok Chat completion surface used by the workspace agent.
...
func (c *grokHTTPClient) Complete(ctx context.Context, messages []ChatMessage) (string, error) {
	if c.apiKey == "" {
...
var _ ChatClient = (*grokHTTPClient)(nil)
